...
.controller('AppCtrl', function($scope, $ionicModal, $timeout) {
  ...
  $ionicModal.fromTemplateUrl('our-list-app/www/templates/noteList.html', {
    scope: $scope
  }).then(function(modal) {
    $scope.modal = modal;
  });
...
.controller('noteCtrl', function($scope, $stateParams, noteContentFactory) {
  ...
  //listens for changes made to the note title and saves new title on each value change.
